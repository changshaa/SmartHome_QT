    ...
    ui(new Ui::device_curtain)
{
    ...
    ui->label_curtain->setStyleSheet("border-image:url(:/png/百叶窗-叶子-关.png)");
    ui->label_curtain->setText("");

    ui->label_lan->setFixedHeight(15);
    ui->label_lan->setStyleSheet("border-image:url(:/png/百叶窗-栏-关.png)");
    ui->label_lan->setText("");

    ui->btn_up->setStyleSheet("border-image:url(:/png/上-关.png)");
    ui->btn_down->setStyleSheet("border-image:url(:/png/下-关.png)");
}
...
void DeviceCurtain::slot_slider_ON(void)
{
    ...
    ui->label_curtain->setStyleSheet("border-image:url(:/png/百叶窗-叶子-开.png)");
    ui->label_lan->setStyleSheet("border-image:url(:/png/百叶窗-栏-开.png)");

    ui->btn_up->setStyleSheet("border-image:url(:/png/上-开.png)");
    ui->btn_down->setStyleSheet("border-image:url(:/png/下-开.png)");
